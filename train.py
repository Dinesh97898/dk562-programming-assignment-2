...
spark = SparkSession.builder.appName("GBT Training").getOrCreate()
...
gbt_classifier = GBTClassifier(labelCol="quality", featuresCol="features", maxIter=100)
trained_model = gbt_classifier.fit(training)
...
trained_model.save("file:///home/ec2-user/modelweights")
